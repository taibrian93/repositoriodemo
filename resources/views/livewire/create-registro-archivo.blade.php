    ...
    <x-jet-form-section :submit="$action" class="mb-4">
        ...
        <x-slot name="form">
            ...
            <div class="form-group col-span-6 sm:col-span-5">
                ...
                <x-select2-component id="departamento" class="mt-1 block w-full form-control shadow-none" wire:model.defer="registroArchivo.idDepartamento" wire:model="departamentoCodigo" wire:change="getCodigoDepartamento">
                    @slot('option')
            ...
            <div class="form-group col-span-6 sm:col-span-5">
                ...
                <x-select2-component id="provincia" class="mt-1 block w-full form-control shadow-none" wire:model.defer="registroArchivo.idProvincia" wire:model="provinciaCodigo" wire:change="getCodigoProvincia">
                    @slot('option')
                        @if (isset($provincias))
